...
ifdef ALTERNATE_CORE_PATH
    ...
    ifndef BOARDS_TXT
        BOARDS_TXT  = $(ALTERNATE_CORE_PATH)/avr/boards.txt
...
SYS_LIBS           := $(wildcard $(addsuffix /src,$(SYS_LIBS)) $(addsuffix /src/utility,$(SYS_LIBS)) $(addsuffix /arch/avr,$(SYS_LIBS)))
